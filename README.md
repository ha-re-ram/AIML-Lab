...
[![AI/ML](https://img.shields.io/badge/Focus-AI%20%26%20ML-orange.svg)](#)
[![Notebooks](https://img.shields.io/badge/Tools-Jupyter-red.svg)](#)
...
[Overview](#-lab-experiments-overview) • [Installation](#-setup--installation) • [Structure](#-project-structure) • [Author](#-author)
...
- [Jupyter Notebook](https://jupyter.org/install) or VS Code
...
```text
AIML-Lab/
├── Experiment-01-DataAnalysis/      # Statistical exploration
├── Experiment-02-TicTacToe-BFS/     # Game AI implementing BFS
├── Experiment-03-8Queens-LocalSearch/ # Local search & heuristics
├── Experiment-04-CSP/               # Water Jug & Map Coloring
├── Experiment-05-Preprocessing/     # Data cleaning pipelines
├── Experiment-06-PCA/               # Dimensionality reduction
├── Experiment-07-NaiveBayes/        # Gaussian Naive Bayes model
├── Experiment-08-Linear-Logistic/   # Regression systems
├── Experiment-09-KMeans/            # Unsupervised clustering
